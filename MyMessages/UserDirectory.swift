...
let RESOURCE_URL = "TODO ACS RESOURCE URL"
let USER_ACCESS_TOKEN = "TODO USER ACCESS TOKEN"
...
class UserDirectory {
    ...
    public static func currentUser() -> User {
        ...
        return getSender(fromId: "8:spool:8d0de54a-ca74-4b37-89ea-75a8ab565166_e701aa-0f00c7d0f0")
    }
